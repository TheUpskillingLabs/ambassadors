...
| `/guide/` | The guide's Home, and the ambassador's dashboard after they pass: one button (Start, Continue, or, once all five are done, "Text your coordinator for your pin") and the five steps. It's open to anyone; people who haven't passed initiation see a nudge to apply, people waiting on their coordinator see "Almost there", and ambassadors are welcomed by name. Anyone who has passed gets **Bring someone in**: share your link, or nominate someone. |
